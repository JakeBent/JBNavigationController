Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   Navigation controller with custom card-like animations with forwards (up to one) and backwards swipe support
                   DESC
  ...
  s.platform     = :ios, '9.0'
  s.source     = { :git => 'https://github.com/JakeBent/JBNavigationController.git', :tag => s.version.to_s}  
